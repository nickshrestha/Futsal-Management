...
class BookingService {
  String baseUrl = "http://localhost:3000/bookings/";
  String error = '';

  Future<bool> create(String date, String time, String username) async {
    final body = jsonEncode({'date': date, 'time': time, 'username': username});
